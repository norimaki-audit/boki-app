/** A4 仕訳・計算用紙の印刷（書いて覚えるモード用）。プロトタイプ printWorksheet() の移植。 */
export function printWorksheet(): void {
  ...
  w.document.write('<!DOCTYPE html><html lang="ja"><head><meta charset="utf-8"><title>仕訳・計算用紙</title><style>@page{size:A4;margin:12mm}body{margin:0;font-family:\'BIZ UDPGothic\',\'Yu Gothic UI\',Meiryo,sans-serif;color:#1a211f;font-size:9pt}</style></head><body>'
